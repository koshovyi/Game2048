...
namespace Game2048.Tests
{
	...
	public class Main
	{
		...
		public void GetHorizontalSlice()
		{
			...
			var slice0 = gameBoard.GetHorizontalSlice(0);
			...
			var slice1 = gameBoard.GetHorizontalSlice(1);
			...
			var slice2 = gameBoard.GetHorizontalSlice(2);
			...
			var slice3 = gameBoard.GetHorizontalSlice(3);
		...
		public void GetVerticalSlice()
		{
			...
			var slice0 = gameBoard.GetVerticalSlice(0);
			Assert.AreEqual(4, slice0.Length);
			Assert.AreEqual(2u, slice0[0]);
			...
			var slice1 = gameBoard.GetVerticalSlice(1);
			Assert.AreEqual(4, slice1.Length);
			...
			var slice2 = gameBoard.GetVerticalSlice(2);
			Assert.AreEqual(4, slice2.Length);
			...
			var slice3 = gameBoard.GetVerticalSlice(3);
			Assert.AreEqual(4, slice3.Length);
