...
namespace Game2048.Tests
{
	...
	public class Moves
	{
		...
		public void MoveUp()
		{
			...
			Assert.AreEqual(8u, slice0[1]);
			Assert.AreEqual(2u, slice0[2]);
			Assert.AreEqual(8u, slice0[3]);

			var slice1 = gameBoard.GetVerticalSlice(1).ToArray();
			Assert.AreEqual(8u, slice1[0]);
			Assert.AreEqual(4u, slice1[1]);
			Assert.AreEqual(0u, slice1[2]);
			Assert.AreEqual(0u, slice1[3]);
			...
			Assert.AreEqual(4u, slice3[0]);
			Assert.AreEqual(4u, slice3[1]);
			Assert.AreEqual(16u, slice3[2]);
			Assert.AreEqual(0u, slice3[3]);
		...
		public void MoveDown()
		{
			...
			Assert.AreEqual(0u, slice1[0]);
			Assert.AreEqual(0u, slice1[1]);
			Assert.AreEqual(8u, slice1[2]);
			Assert.AreEqual(4u, slice1[3]);

			var slice2 = gameBoard.GetVerticalSlice(2).ToArray();
			Assert.AreEqual(0u, slice2[0]);
			Assert.AreEqual(0u, slice2[1]);
			Assert.AreEqual(4u, slice2[2]);
			Assert.AreEqual(4u, slice2[3]);

			var slice3 = gameBoard.GetVerticalSlice(3).ToArray();
			Assert.AreEqual(0u, slice3[0]);
			Assert.AreEqual(4u, slice3[1]);
			Assert.AreEqual(4u, slice3[2]);
			Assert.AreEqual(16u, slice3[3]);
